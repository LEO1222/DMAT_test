...
# data=df.head(n=4)# read 4 rows (for specify reading range)
# print('obtained value:\n{0}'.format(df)) # format dataframe and output
# print('-'*60)

# DataFrame -----> Python List
data_value = df.values.tolist()
# print('All variabels\' list is:\n',data_value)
# print('-'*60)

# Specify which ROW through index!!! Could do some upgrades here to determine and match the category of each variable
# index = 0
# print(f'The {(data_value[index])[0]} values are:\n', (data_value[index])[1:])  # print all voltage values 
# print('-'*60)
##############################################################################################################################
...
if pscad:
    ...
    try:
        ...
        if len(sim_sets) > 0:
            ...
            # FaultType = canvas.find("master:consti", "FaultType_Setting")
